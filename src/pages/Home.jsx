...
const Home = () => {
    ...
    return (
        <div className="overflow-hidden" id="home">
            ...
            {/* Interactive On-Grid Architecture Section */}
            <section className="py-16 md:py-32 bg-brand-green-dark relative overflow-hidden">
                <div className="container-custom relative z-10">
                    <div className="text-center max-w-4xl mx-auto mb-20">
                        <span className="text-brand-yellow font-black uppercase tracking-widest text-sm inline-block mb-4">On-Grid Solar System Architecture</span>
                        <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight">
                            Smart Solar for <br />
                            <span className="text-brand-yellow decoration-brand-yellow/30 underline decoration-8 underline-offset-8">Uttarakhand & Dehradun</span>
                        </h2>
                        <p className="text-white/60 text-lg">Seamless energy flow between your home and the grid. Engineered for maximum savings with <span className="text-white font-bold">Solar House Dehradun</span>.</p>
                    </div>

                    <div className="relative glass-card bg-white/[0.02] border-white/5 p-8 md:p-20 rounded-[3rem] overflow-hidden">
                        {/* The Schematic Layout */}
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-8 items-center relative">

                            {/* 1. Solar Panel */}
                            <div className="flex flex-col items-center gap-6 z-10">
                                <div className="w-24 h-24 md:w-32 md:h-32 glass-card bg-brand-yellow/10 flex items-center justify-center text-brand-yellow border-brand-yellow/20 group hover:bg-brand-yellow hover:text-brand-green-dark transition-all duration-500">
                                    <Sun size={48} />
                                </div>
                                <span className="text-sm font-black uppercase tracking-widest text-white/40">Solar Panels</span>
                            </div>

                            {/* 2. Inverter */}
                            <div className="flex flex-col items-center gap-6 z-10">
                                <div className="w-24 h-24 md:w-32 md:h-32 glass-card bg-white/5 flex flex-col items-center justify-center p-4 border-white/10">
                                    <div className="w-full h-2 bg-brand-yellow/20 rounded-full overflow-hidden mb-2">
                                        <motion.div
                                            animate={{ x: ["-100%", "100%"] }}
                                            transition={{ repeat: Infinity, duration: 2, ease: "linear" }}
                                            className="w-1/2 h-full bg-brand-yellow"
                                        />
                                    </div>
                                    <Zap className="text-brand-yellow" size={32} />
                                </div>
                                <span className="text-sm font-black uppercase tracking-widest text-white/40">Smart Inverter</span>
                            </div>

                            {/* 3. Net Meter */}
                            <div className="flex flex-col items-center gap-6 z-10">
                                <div className="w-24 h-24 md:w-32 md:h-32 glass-card bg-white/5 flex flex-col items-center justify-center p-4 border-white/10 group">
                                    <div className="text-brand-yellow font-mono text-xs mb-2">0248.5 kW</div>
                                    <Clock className="text-brand-yellow group-hover:rotate-180 transition-transform duration-1000" size={32} />
                                </div>
                                <span className="text-sm font-black uppercase tracking-widest text-white/40">Net Meter</span>
                            </div>

                            {/* 4. House */}
                            <div className="flex flex-col items-center gap-6 z-10">
                                <div className="w-24 h-24 md:w-32 md:h-32 glass-card bg-brand-green-light/20 flex items-center justify-center text-brand-green-light border-brand-green-light/20">
                                    <HomeIcon size={48} />
                                </div>
                                <span className="text-sm font-black uppercase tracking-widest text-white/40">Your Home</span>
                            </div>

                            {/* 5. Grid */}
                            <div className="flex flex-col items-center gap-6 z-10">
                                <div className="w-24 h-24 md:w-32 md:h-32 glass-card bg-white/5 flex items-center justify-center text-white/40 border-white/10">
                                    <Zap size={48} strokeWidth={1} />
                                </div>
                                <span className="text-sm font-black uppercase tracking-widest text-white/40">Uttarakhand Grid</span>
                            </div>
                            ...
                            <div className="hidden lg:block absolute inset-0 pointer-events-none">
                                <svg className="w-full h-full" viewBox="0 0 1000 400">
                                    ...
                                    <motion.path
                                        d="M150 200 L250 200"
                                        stroke="white" strokeWidth="2" strokeDasharray="8 8" strokeOpacity="0.2"
                                    ...
                                    <motion.path
                                        ...
                                        transition={{ repeat: Infinity, duration: 2, ease: "linear" }}
                                    />
                                    {/* Net Meter split to House and Grid */}
                                    <motion.path
                                        d="M550 200 L650 200"
                                        stroke="white" strokeWidth="2" strokeDasharray="8 8" strokeOpacity="0.2"
                                        animate={{ strokeDashoffset: [0, -40] }}
                                    ...
                                    <motion.path
                                        d="M750 200 L850 200"
                                        stroke="#fbbf24" strokeWidth="2" strokeDasharray="8 8"
                                        animate={{ strokeDashoffset: [0, -40] }}
                                        transition={{ repeat: Infinity, duration: 2, ease: "linear" }}
                                    />
                                </svg>
                        ...
                        {/* System Labels */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-20 pt-10 border-t border-white/5 text-xs uppercase tracking-widest font-black text-white/20">
                            <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-brand-yellow animate-pulse" /> Energy Generation</div>
                            <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-brand-green-light" /> Internal Usage</div>
                            <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-blue-500" /> Grid Banking</div>
                            <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-white/40" /> Smart Monitoring</div>
                        </div>
                    </div>
                </div>
            </section>
